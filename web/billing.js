...
export const billingConfig = {
  ...
  basic: {
    ...
    usageTerms: [
      ...
      "Generate descriptions from a subset of contextual templates", 
      "Select key points from your products, variants, and collections",
      "Expand on an existing description",
      "Track key points in your description",
    ],
  },
  crafted: {
    amount: 60.0,
    ...
    usageTerms: [
      ...
      "Access to real time Readability Metrics",
      "Access to real time Sentiment Analysis",
